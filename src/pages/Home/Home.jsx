  ...
  return (
    <main className="home-container">
      ...
      <p className="home-subtitle">
        Crie sua lista de destinos dos sonhos! Adicione países que você quer
        visitar, marque os lugares que já conheceu e planeje sua próxima
        aventura pelo mundo.
      </p>
      ...
      <section className="card-grid">
        <Link to="/lista" className="card">
          ...
          <h2>Minha Lista</h2>
          <p>
            Veja todos os destinos da sua bucket list e marque os lugares que já
            visitou
          </p>
        </Link>
